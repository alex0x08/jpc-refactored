...
public class PCMonitorFrame extends JFrame implements Runnable
{
    ...
    public PCMonitorFrame(String title, PC pc, String[] args)
    {
        ...
        file.add("Start").addActionListener(e -> start());
        file.add("Stop").addActionListener(e -> stop());
        file.add("Reset").addActionListener(e -> reset());
        file.addSeparator();
        file.add("Save Configuration").addActionListener(e -> saveConfig());
        file.add("Load Configuration").addActionListener(e -> loadConfig());
        file.addSeparator();
        file.add("Quit").addActionListener(e -> System.exit(0));
