...
public class PC {
    ...
    public Integer savePage(Integer page, byte[] data, Boolean linear) throws IOException
    {
        ...
        return physicalAddr.getPage(translateLinearAddressToInt(physicalAddr, processor, page), data);
    }
    ...
    public void loadPage(Integer page, byte[] data, Boolean linear) throws IOException
    {
        if (!linear)
            ...
            physicalAddr.setPage(translateLinearAddressToInt(physicalAddr, processor, page), data);
    }
